...
Estado actual: **Backend 42 pruebas ✓ · Frontend 47 pruebas ✓**
...
| ------- | ------ | ---------- |
| `test_transporte.py` | 7 | Auth Basic, errores HTTP seguros, errores de red, JSON inválido/inesperado y estados 203/204/3xx |
...
**Total: 47 en el frontend (10 archivos) y 42 en el backend.**
